    ...
    def update(self, instance, validated_data):
        ...
        with transaction.atomic():
            ...
            if remember_data:
                defaults = {
                    "break_start": (
                        validated_data.get("break_start") or self.instance.break_start
                    ),
                    "break_end": (
                        validated_data.get("break_end") or self.instance.break_end
                    ),
                    "break_max_duration": (
                    ...
                    "min_active": (
                        validated_data.get("min_active") or self.instance.min_active
                    ),
                }
                group = instance.group
                for key, value in defaults.items():
