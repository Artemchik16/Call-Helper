...
class ReplacementMember(models.Model):
    ...
    replacement = models.ForeignKey(
        "breaks.Replacement", models.CASCADE, "members_info", verbose_name="Смена"
    )
    status = models.ForeignKey(
        "breaks.ReplacementStatus", models.RESTRICT, "members", verbose_name="Статус"
    )
